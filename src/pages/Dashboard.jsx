...
function Dashboard() {
  ...
  const loadProducts = async () => {
    try {
      const res = await axios.get("https://reactbackend-production-cdc8.up.railway.app/api/products");
  ...
  const addProduct = async () => {
    ...
    await axios.post("https://reactbackend-production-cdc8.up.railway.app/api/products", {
      name,
